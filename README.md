...
- We further incorporate a curriculum learning strategy in the Seidel parameter space to improve PRCDUN's robustness under forward-model mismatch and enhance its generalization across diverse aberration distributions.
